            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <StatBox
                  ...
                  icon={<Diff size={14} className="text-zinc-500" />}
                />
                <StatBox
              ...
              <div className="card p-0 overflow-hidden">
                  ...
                  <div className="p-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                      {comparison.commonKeysWithSameValue.map((key: string, i: number) => (
                        <div key={i} className="px-3 py-2 bg-zinc-50 dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 rounded-lg text-xs font-mono text-zinc-700 dark:text-zinc-300 truncate flex items-center gap-2">
                ...
                {selectedView === 'all' && (
                  <div className="p-10 flex flex-col items-center justify-center text-center space-y-3">
                    ...
                    <h2 className="text-sm font-semibold text-zinc-900 dark:text-zinc-100">Comparison Ready</h2>
                    <p className="text-xs text-zinc-500 max-w-sm">Use the tabs in the header to inspect key differences or value overrides between your environments.</p>
                  </div>
                )}
              </div>
            </div>

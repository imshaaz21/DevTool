            ...
            <main className="flex-1 ml-64 min-h-screen overflow-hidden">
                ...
                <div className="sticky top-0 z-10 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-6 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <h1 className="text-2xl font-bold">JSON Comparison</h1>
                        <div className="flex items-center gap-4">
                            {viewMode === 'comparison' && (
                                <div className="flex items-center gap-2">
                                    ...
                                    >
                                        <option value="diff">Line-by-Line Diff</option>
                            ...
                            {viewMode === 'input' ? (
                                <button onClick={handleCompare} className="btn btn-primary flex items-center gap-2">
                                    Compare JSONs
                                </button>
                            ) : (
                ...
                {viewMode === 'comparison' && comparison && (
                    <div className="p-6 space-y-6">
                        ...
                        {/* 2. Professional Side-by-Side Diff Viewer */}
                        {(selectedView === 'diff' || selectedView === 'all') && (
                            <div className="card">
                                <h2 className="text-xl font-semibold mb-4">Line-by-Line Comparison</h2>

...
export function PageHeader({
  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-3 px-6 py-3 border-b border-neutral-200 dark:border-neutral-800 bg-white dark:bg-[#0a0a0c] sticky top-0 z-20 shrink-0">
